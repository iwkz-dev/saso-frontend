    ...
    const tableHead = useMemo(
        () => [
            ...
            },
            {
                ...
                options: [
                    { title: "Draft", value: "draft", code: 0 },
                    { title: "Approved", value: "approved", code: 1 },
                    { title: "Done", value: "done", code: 2 },
                ],
            },
            {
                key: "po_closed",
                ...
                options: [
                    { title: "No", value: "no", code: false },
                    { title: "Yes", value: "yes", code: true },
                ],
            },
            { key: "started_at", dataIndex: "started_at", title: "Started At" },
            { key: "created_at", dataIndex: "created_at", title: "Created At" },
            { key: "updated_at", dataIndex: "updated_at", title: "Updated At" },
        ],
        [onChangeStatus, onChangePOClosed],
    );
